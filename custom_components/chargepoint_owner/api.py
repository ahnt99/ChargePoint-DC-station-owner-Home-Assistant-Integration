...
class ChargePointClient:
    ...
    def get_load(self, station_id: str) -> dict:
        ...
        The getLoad searchQuery uses an anonymous inline type in the WSDL
        (not a named type) — pass it as a plain dict so zeep handles it correctly.
        """
        response = self._call("getLoad", searchQuery={"stationID": station_id})
    ...
    def _get_raw_load(self, station_id: str) -> Any:
        ...
        return self._call("getLoad", searchQuery={"stationID": station_id})
